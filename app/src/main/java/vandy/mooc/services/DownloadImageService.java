...
public class DownloadImageService extends IntentService {
    ...
    public void onHandleIntent(Intent intent) {
        ...
        // @@ TODO -- you fill in here.
        String directoryName=intent.getStringExtra(DIRECTORY_PATHNAME);

        // Download the requested image.
        // @@ TODO -- you fill in here.
        Utils.downloadImage(getApplicationContext(),url,directoryName);
        ...
        message.arg1=directoryName==null?Activity.RESULT_CANCELED : Activity.RESULT_OK;
        Bundle bundle=new Bundle();
        bundle.putString(IMAGE_PATHNAME,directoryName);
        message.setData(bundle);
        sendPath(messenger,Uri.parse(directoryName),url);
    }
